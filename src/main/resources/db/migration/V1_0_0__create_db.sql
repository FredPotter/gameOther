...
create table users (account_status smallint not null check (account_status between 0 and 1), user_status smallint not null check (user_status between 0 and 1), balance bigint, country_id bigint, id bigint not null, last_login_date date, registration_date date not null, email varchar(255), login varchar(255) not null, password varchar(255) not null, path_to_avatar varchar(255), username varchar(255) not null, primary key (id));
