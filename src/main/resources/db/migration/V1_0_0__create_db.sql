...
create table message (id bigint not null, message_date date not null, receiver_id bigint, sender_id bigint, message_subject varchar(255) not null, text varchar(255) not null, is_deleted boolean, primary key (id));
create table message_to_support (id bigint not null, message_date date not null, sender_id bigint, message_subject varchar(255) not null, text varchar(255) not null, is_deleted boolean, primary key (id));
